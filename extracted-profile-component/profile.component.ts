...
export class ProfileComponent implements OnInit {
  ...
  // 安全的图片URL
  safeDefaultImage!: SafeResourceUrl;
  safeHoverImage!: SafeResourceUrl;
  safeLineImage!: SafeResourceUrl;
  ...
  ngOnInit(): void {
    // 初始化安全图片URL
    this.safeDefaultImage = this.getSafeImageUrl('assets/img/Me.png');
    this.safeHoverImage = this.getSafeImageUrl('assets/img/mecloud.png');
    this.safeLineImage = this.getSafeImageUrl('assets/img/line-1.svg');

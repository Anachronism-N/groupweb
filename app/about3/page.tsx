...
export default function About3Page() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: "url(/bg/bg_NZC.jpg)",
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-around lg:px-24">
              <div className="order-2 mx-auto max-w-lg lg:order-1 lg:m-0 lg:max-w-3xl lg:pr-12">
                ...
                <h1 className="mx-auto max-w-2xl text-balance text-center text-4xl font-medium leading-tight tracking-tighter text-text-primary md:text-5xl lg:text-left lg:text-6xl lg:leading-[64px]">
                  I&apos;m Nie Zichao, a student from SIGS.
                </h1>
              </div>
            ...
            <div className="space-y-4">
              ...
              <GridWrapper>
                <h2 className="mx-auto max-w-xl text-balance text-3xl font-medium leading-[40px] tracking-tighter text-text-primary">
                  Here&apos;s a quick intro about Hackathon and what I want to
              ...
              <div className="grid grid-cols-1 gap-8 py-12 pr-12 lg:grid-cols-2 lg:items-center lg:justify-between lg:py-32 lg:pb-20 xl:py-32">
                <div className="flex flex-col items-center text-left lg:order-2 lg:items-start">
                  ...
                  <p className="mb-6 text-base leading-8 text-text-secondary">
                    Students pursuing graduate recommendations face three
                    blockers: fragmented, outdated info; fuzzy goals that fuel
                    anxiety; and tools that stop at navigation instead of
                    decision support. We turn passive reading into an
                    interactive decision journey. With branch-based tasks,
                    scenario dialogues, and visual milestones, students learn by
                    choosing, get timely feedback, and convert information into
                    concrete action plans—reducing missed deadlines, clarifying
                    priorities, and sustaining momentum across the entire
